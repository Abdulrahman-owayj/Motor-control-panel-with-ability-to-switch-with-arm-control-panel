        ...
        <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
            ...
            if($_SERVER["REQUEST_METHOD"] == "POST"){
                try {
                    ...
                    $conn->query($SQuery);
                    header("Location: /robot/First Task/FTask.php");
                } catch (\Throwable $th) {
                    //throw $th;
                    echo "Bad";
                }
...
<button id="BackButton1" name="BackButton1" ><a  href="../../robot/second Task/secondTask.html">التحكم بالموتور</a></button>
  ...
  window.watsonAssistantChatOptions = {
      integrationID: "67bbefa5-1f86-45f4-8cb2-586b42d2e270", // The ID of this integration.
      region: "eu-gb", // The region your integration is hosted in.
      serviceInstanceID: "85531985-51b1-4b8c-a100-e002502a3e3a", // The ID of your service instance.
